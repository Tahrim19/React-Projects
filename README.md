...
| Anime Dashboard | An anime dashboard built with ReactJS using the Jikan API, featuring a responsive layout using Tailwindcss, ReactIcon, pagination, and detailed views of anime, along with custom charts and interactive components  | [Repo](https://github.com/Tahrim19/dashboard.git) |[Demo](https://dashboard-rosy-five.vercel.app) |
